...
import m.com.service.Page.FirstActivity;
import m.com.service.Page.FourthActivity;
import m.com.service.Page.SecondActivity;
...
public class MainActivity extends ActivityGroup implements OnClickListener{
    ...
    private void changeContainerView(View v) {
        ...
        if (v == ll_first) {
            ...
            toActivity("first", FourthActivity.class);
        } else if (v == ll_second) {
            ...
            toActivity("forth",FourthActivity.class);
        }
    }
